...
HD_PWD='D:/LABWORK/DSD/Lab/fsmd/fsmd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsmd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsmd.tcl -notrace
